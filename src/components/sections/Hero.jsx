...
const Hero = () => {
  ...
  const socialLinks = [
    ...
    { icon: Linkedin, href: "https://linkedin.com/in/jDudhrejiya090", label: "LinkedIn" },
    { icon: Mail, href: "mailto:your@email.com", label: "Email" }
  ];

  return (
    <section className="min-h-screen bg-black relative overflow-hidden flex items-center justify-center" id='hero'>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/4 text-orange-500/20 text-6xl font-mono animate-float">{'{ }'}</div>
        <div className="absolute top-3/4 right-1/4 text-orange-500/20 text-4xl font-mono animate-float-delayed">{'< />'}</div>
        <div className="absolute top-1/2 right-1/3 text-orange-500/20 text-5xl font-mono animate-float-slow">{'[]'}</div>
      </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between min-h-screen py-20">
          ...
          <div className={`lg:w-1/2 text-center lg:text-left transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
            ...
            <div className="flex items-center justify-center lg:justify-start mb-4">
              ...
              <span className="text-orange-500 font-medium tracking-wide">Hello, I'm</span>
            </div>
